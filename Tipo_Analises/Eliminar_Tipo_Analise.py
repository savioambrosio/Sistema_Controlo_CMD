...
def Eliminar_analise():
    while True:
        ...
        def eliminar():
            ...
            limpar()
            estilo()
            print("************ Eliminar Tipo de Analises **********")
            estilo()
            ...
            if not comparar:
                ...
                print(f"Encontrados {len(comparar)} tipos de analise com o nome '{valor}':")
                linhas()
                
                for cliente in comparar:
                    print(f" * Código: {cliente['Codigo']}, Preco: {cliente['Preco']}")
                linhas()
                if len(comparar) >=2:
                    chave = 'Codigo'
                    estilo()
