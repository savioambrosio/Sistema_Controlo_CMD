...
def Inserir_resultado():
    while True:
        ...
        def inserir(caminho):
            ...
            return {"Codigo": proximo_id,"Cliente": Cliente, "Tipo_Analise": Tipo_Analise,"Data": Data,"Resultado": Resultado}
        ...
        continuar = input("Deseja inserir outro Resultado? (s/n): ").lower()
        if continuar != 's':
            break
