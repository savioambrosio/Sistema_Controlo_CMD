...
def Alterar_analises():
    ...
    def alterar_dados(caminho,chaves,chave_a_alterar,novo_valor,Idade,preco):
    ...
    estilo()
    print("************** Alterar  Analises *************")
    estilo()
    
    novo_valor = "0"
    per = "0"
    
    resultados = alterar_dados(caminho,chaves,chave_a_alterar,novo_valor,Idade,preco)
    
    if resultados:
        tabela = PrettyTable()
        tabela.field_names = ["Código", "Nome", "Tipo_analise", "Preco"]
