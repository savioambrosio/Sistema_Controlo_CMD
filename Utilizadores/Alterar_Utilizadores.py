...
def Alterar_utilizadores():
    ...
    def alterar_dados(caminho,chaves,chave_a_alterar,novo_valor):
    ...
    estilo()
    print("************** Alterar  Utilizadpres *************")
    estilo()
    
    novo_valor = "0"
    per = "0"
    
    resultados = alterar_dados(caminho,chaves,chave_a_alterar,novo_valor)
